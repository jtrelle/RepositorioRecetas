        ...
        <section class="container" style="padding: 30px 0px;background-color: white;">
            <div class="row" style="padding-top: 60px;">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-xs-12 col-xs-offset-0">
                        <img  src="../images/calabaza_y_Champinone.jpg" alt="text" class="imagen"/>
                    </div>                    
                    <div class="col-md-6 col-xs-12 col-xs-offset-0">
                        <h3>Ingredientes:</h3>  
                        <ul class="b">
                            <li>1 cebolla pequeña</li>
                            <li>200g de champiñones</li>
                            <li>1 kilo de calabaza</li>
                            <li>½ cdita de aceite de maíz</li>
                            <li>Caldo de verdura</li>
                            <li>50 ml de crema de leche</li>
                            <li>1 cda de miel</li>
                            <li>½ cdita de curry suave</li>
                            <li>Sal a gusto</li>
                            <li>Cebollin para decorar</li>
                        </ul>
                                 
                    </div>  
                    <div class="col-md-12 col-xs-12 col-xs-offset-0">
                        <h3>Preparación:</h3>  
                        <p>Picar la cebolla y los champiñones. Pelar la calabaza, partirla por el medio, descartar las semillas y cortar la pulpa en cubos. Cocinar la cebolla en una olla onda con ½ cucharadita de aceite. Agregar los champiñones y cocinar 4 minutos más, a fuego suave, para que pierdan rigidez sin tomar color. Incorporar a la olla los cubos de calabaza, cubrir con caldo y cocinar a fuego fuerte, con el recipiente destapado, hasta que la calabaza este muy tierna. Colar, recuperando el caldo. Procesar los vegetales. Ponerlos de nuevo en la olla. Añadir la crema de leche y caldo suficiente para lograr una consistencia cremosa, no demasiado liquida. Adicionar la miel y el curry, salar con moderación y cocinar durante 5 minutos más. Servir la sopa caliente, adornada con cebollin picado y láminas de champiñones.</p>
                    </div>
                </div>
            </div>
        </section>
