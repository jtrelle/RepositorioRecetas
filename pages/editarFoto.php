                    ...
                    <div class="login-class pull-right">
                     <div class="comp pull-right  ">
                        ...
                        <div class="comp pull-right  ">
                            ...
                            <?php 
                      echo "<a href='profile.php' class='hdr-btn link-reset demo-dialog-open-button login-item'>".$_SESSION['MiSession']."</a> "; 
                    ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <form class="form-foto" method="POST" action="../php/collectors/users/actions/upload.php" enctype="multipart/form-data">
