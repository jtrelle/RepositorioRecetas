...
?>
 ...
 <?php
  ...
  <!--       *******  BODY    *******     -->
    ...
    <div class="container" style="padding: 80px 0px;background-color: white;" >
        <div class="row">
            <div class="col-sm-6 col-md-4 col-xs-12">
                   
                    
                <div class="card nutri">
                   <div class="nutricionistas-img-container">
                        <img src="../images/nutricionista.jpg" class="img-circle" alt="nutricionista"/>
                    </div>
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="nutri-grade">
                              Licda. en Nutrición
                        </div>
                        <p>"Nuestro propósito es ayudar a mantener
                        la salud de nuestros usuarios y mejorar
                        su calidad de vida."</p>
                        <div class="nutri-grade">
                            Correo: susanacedeño@example.com
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xs-12">
                ...
                <div class="card nutri">
                   <div class="nutricionistas-img-container">
                        <img src="https://yt3.ggpht.com/-ZkgSgat9CTM/AAAAAAAAAAI/AAAAAAAAAAA/nssXzGDH58c/s100-c-k-no-mo-rj-c0xffffff/photo.jpg" class="img-circle" alt="nutricionista"/>
                    </div>
                    <div class="col-md-12 col-xs-12">
                        <div class="nutri-title">
                            Dr. Felipe Trelles
                        ...
                        su calidad de vida."</p>
                        <div class="nutri-grade">
                            Correo: felipetrelles@example.com
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-xs-12">
                ...
                <div class="card nutri">
                   <div class="nutricionistas-img-container">
                        <img src="https://media.licdn.com/mpr/mpr/shrink_100_100/AAEAAQAAAAAAAAgLAAAAJGJhZmM4NTU4LTY3MTEtNGQ4Yy1hNDE2LTY3MWYwNjFmZjQ5MQ.jpg" class="img-circle" alt="nutricionista"/>
                    </div>
                    <div class="col-md-12 col-xs-12">
                        <div class="nutri-title">
                           Juan Pérez
