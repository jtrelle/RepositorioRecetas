...
<div id="header" class="terminal-header ">
    ...
    <header class="regular-header clearfix hide-sm hide-xs" id="new-header">
        ...
        <div class="login-class pull-right">
            ...
            <div class="comp pull-right  ">
                <a href="ingresar.html" class="hdr-btn link-reset demo-dialog-open-button login-item">
                    INICIAR SESIÓN
                </a>
            </div>
            ...
            <!-- Registro -->
            <div  class="comp pull-right  ">
                <a href="registro.html" data-header-view="true" class="hdr-btn link-reset login-item">
                    REGÍSTRATE
                </a>
            </div>
        </div>
  ...
  <h2>Vertical (basic) form</h2>
    ...
    <form action="../php/login/login.php" method="post"> <!-- manda el modo POST a la página LOGIN.PHP -->
    <fieldset>
        ...
        <div id="login">   
          ...
          <div class="estructurados">
            ...
            <input class="inputre" type="email" name="user" required autocomplete="true" placeholder="Ingrese email" />
          </div>
