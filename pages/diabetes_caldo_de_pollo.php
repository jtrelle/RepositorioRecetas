            ...
            <div class="row" style="padding-top: 60px;">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-xs-12 col-xs-offset-0">
                        <img  src="../images/caldo-pollo-verduras.jpg" alt="text" class="imagen"/>
                    </div>                    
                    <div class="col-md-6 col-xs-12 col-xs-offset-0">
                        <h3>Ingredientes:</h3>  
                        <ul class="b">
                            <li>Un pollo mediano (limpio eviscerado y con piel)</li>
                            <li>100 gr. de fideos</li>
                            <li>2 nabos</li>
                            <li>3 zanahorias</li>
                            <li>1 puerro</li>
                            <li>1 patata</li>
                            <li>2 ramas de apio verde</li>
                            <li>una rodaja de calabaza pelada</li>
                    ...
                    <div class="col-md-12 col-xs-12 col-xs-offset-0">
                        <h3>Preparación:</h3>  
                        <p>Introduce en una olla grande el pollo troceado y cúbrelo con 3 litros de agua. Lleva a ebullición.
Una vez el agua rompa a hervir, ve añadiendo a la olla las verduras peladas y troceadas. Salpimenta y añade la ramita de perejil.
Deja hervir a fuego muy suave durante una hora y media, hasta obtener un caldo sustancioso.
Una vez tengamos el caldo listo, cuélalo y reserva las verduras y el pollo.
Pon a hervir de nuevo el caldo y añádele los fideos. Cuece hasta que la pasta quede cocida.</p>
                    </div>
                </div>
            </div>
        </section>
