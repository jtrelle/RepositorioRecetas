<?php
  ...
  $objPeople = $userCollectorObj->showPeople($_SESSION['PeopleId']);
...
<form action="actualizarPerfil.php" method="POST" class="estructura">
        ...
        <div id="signup">   
          ...
          <div class="estructurados">
            ...
            <div class="field-wrap">
              ...
              <input class="inputre" value="<?php echo $objPeople->getPeopleName();?>" name="pName" type="text" />
            </div>
  ...
  <div class="field-wrap">
              ...
              <input class="inputre" value="<?php echo $objPeople->getPeopleSurname();?>" name="pSurname" type="text" />
            </div>
             ...
             <div class="field-wrap">
              ...
              <input class="inputre" value="<?php echo $objPeople->getPeopleEmail();?>" name="pEmail" type="text" />
            </div>
