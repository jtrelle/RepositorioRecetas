...
if (isset($_SESSION['MiAdmin'])){
  ...
  $objUser = $userCollectorObj->showUser($_SESSION['UserId']);
        ...
        <div id="header" class="terminal-header ">
            ...
            <div class="regular-header hidden-sm hidden-md hidden-xs">
                ...
                <div class="comp pull-left" style="margin-top: 8px;">
                    <a href="../index.php" class="hdr-btn link-reset belo-container"> <img alt="" style="width:160px;" src="../images/logos/logo.png" /> </a>
                </div>
                <?php
  if (isset($_SESSION['MiSession'])){
...
?>
                    ...
                    REGÍSTRATE
                        ...
                        <?php } ?>
                            ...
                            <div class="comp pull-left  "> <a href="recetas.html" data-header-view="true" class="hdr-btn link-reset menu-item">
                RECETAS
            </a> </div>
                            <div class="comp pull-left  "> <a href="nutricionistas.html" data-header-view="true" class="hdr-btn link-reset menu-item">
                NUTRICIONISTAS
            </a> </div>
                            <div class="comp pull-left"> <a href="contacto.html" data-header-view="true" class="hdr-btn link-reset menu-item">
                CONTACTO
            </a> </div>
            </div>
            <!-- BARRA DE NAVEGACIÓN Medium / Small Screen --><span class="burger-span hidden-lg"><i class="fa fa-bars fa-2x" aria-hidden="true"></i></span>
            <div class="regular-header burger hidden-lg">
                <!-- Logo --><span class="burger-span exit"><i class="fa fa-times fa-2x" aria-hidden="true"></i></span>
                <div class="comp pull-left" style="margin-top: 8px;">
                    <a href="index.php" class="hdr-btn link-reset belo-container"> <img alt="" style="width:160px;" src="../../../../images/logos/logo.png" /> </a>
                </div>
                <!--Buscar medio -->
...
<form action="actualizarCuenta.php" method="POST" class="estructura">

        <div id="signup">   
          <h1 class="texto">Editar cuenta</h1>
          ...
          <div class="estructurados">
            ...
            <div class="field-wrap">
              ...
              <input class="inputre" value="<?php echo $objUser->getUserUsername();?>" name="username" type="text" />
            </div>
  ...
  <div class="field-wrap">
              ...
              <input class="inputre" value="<?php echo $objUser->getUserPassword();?>" name="pass" type="password" />
            </div>
             ...
             <div class="field-wrap">
              ...
              <input class="inputre" value="<?php echo $objUser->getUserPassword();?>" name="pass2" type="password" />
            </div>
          
          <button type="submit" class="button button-block">Editar</button>
