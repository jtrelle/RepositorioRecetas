...
$RecipesUsersCollectorObj = new RecipesUsersCollector();
  ...
  echo "   <tr>";
  echo "   <th>Id</th>";
  echo "   <th>Recipes Id</th>"; 
  echo "   <th>Users Id</th>"; 
  echo "   </tr>";
  echo " </thead>";
  echo "<tbody>";

foreach ($RecipesUsersCollectorObj->showRecipesUsers() as $c){
  echo "<tr>";
  echo "<td>" . $c->getIdRecipesUsers() . "</td><td>" . $c->getRecipesId() . "</td><td>" . $c->getUserId() . "</td>";
  echo "<td> <a href='EditRecipesUsers.php?id=".$c->getIdRecipesUsers()."' class='btn btn-info' role='button'>Editar</a> ";
  echo "<a href='DeleteRecipesUsers.php?id=".$c->getIdRecipesUsers()."' class='btn btn-info' role='button'>Eliminar</a> </td>";      
