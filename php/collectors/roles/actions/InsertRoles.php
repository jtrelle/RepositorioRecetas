...
<div class="container">
  <h2>Crear el Objeto Role</h2>
  <form class="form-horizontal" action="formrolescreate.php" method="post">
    

   <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Role:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" name="role" value="<?php echo $ObjRoles->setRole($role); ?>" autofocus required/>
    </div>
    </div>
