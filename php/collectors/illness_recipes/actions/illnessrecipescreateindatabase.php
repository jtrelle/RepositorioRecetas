...
$IllnessRecipesCollectorObj->createIllnessRecipes( $illnessid, $recipesid);
echo '<script language="javascript">';
      echo 'alert("Creación de la informacion en la base de datos");document.location.href="illnessrecipeslist.php"';
      echo '</script>';
